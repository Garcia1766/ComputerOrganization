...
parameter BASE_RAM_INIT_FILE = "E:\\Code\\mips32lab\\supervisor-mips32\\kernel\\kernel.bin"; //BaseRAM初始化文件，请修改为实际的绝对路径
//parameter BASE_RAM_INIT_FILE = "E:\\Code\\mips32lab\\testbench\\exception.bin";
